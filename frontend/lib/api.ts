...
export async function loginTeam(teamName: string, teamPasscode: string): Promise<string> {
  ...
  // The backend returns a plain string, e.g., "Login Successful" or "Invalid Credentials"
